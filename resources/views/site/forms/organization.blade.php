            ...
            <div class="bg-white pa3 mb5">
                ...
                <div class="cf">
                    <div class="fl w-100 w-50-ns ph3">
                        <div class="mb4">
                            <input class="input-reset f-input bn pa2 mb2 db w-100" type="text" name="name" placeholder="Nombre*" value="{{ old('name') }}">
                            @if($errors->has('name'))
                                <span class="f6 red">{{ $errors->first('name') }}</span>
                            @endif
                        </div>
                        <div class="mb4">
                            <input class="input-reset f-input bn pa2 mb2 db w-100" type="text" name="phone" placeholder="Teléfono*" value="{{ old('phone') }}">
                            @if($errors->has('phone'))
                                <span class="f6 red">{{ $errors->first('phone') }}</span>
                            @endif
                        </div>
                        <div class="mb4">
                            <input class="input-reset f-input bn pa2 mb2 db w-100" type="text" name="email" placeholder="Correo electrónico*" value="{{ old('email') }}">
                            @if($errors->has('email'))
                                <span class="f6 red">{{ $errors->first('email') }}</span>
                            @endif
                        </div>
                        <div class="mb4">
                            <input class="input-reset f-input bn pa2 mb2 db w-100" type="text" name="description" placeholder="Descripción corta*" value="{{ old('description') }}">
                    ...
                    <div class="fl w-100 w-50-ns ph3">
                        ...
                        <div class="mb4">
                            <input class="input-reset f-input bn pa2 mb2 db w-100" type="text" name="website" placeholder="Sitio Web*" value="{{ old('website') }}">
